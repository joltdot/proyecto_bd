...
| `latitud`, `longitud` | `UPDATE` | 5 registros con longitud positiva (fuera de CDMX): 2 tienen el signo invertido (99.x → −99.x) y 3 tienen la latitud duplicada en el campo de longitud (~19.x). | Se corrigió el signo en los 2 primeros y se nullearon los 3 restantes por ser irrecuperables. |
...
# Conclusiones 
 ...
 5. Durante la madrugada disminuyen considerablemente los accidentes, lo que confirma que el volumen vehicular es uno de los factores más importantes.
 6. El tiempo de respuesta (captura) varía significativamente por zona — las colonias del sur y oriente tardan más en ser registradas, lo que podría indicar menor cobertura operativa.
 7. Los accidentes se concentran principalmente en alcaldías con alta densidad poblacional y gran actividad económica. Alcaldías como Cuauhtémoc, Iztapalapa y Gustavo A. Madero, son las zonas con mayor movilidad diaria además de flujo vehicular y también las que presentan más incidentes.
 8. Al analizar los tipos de incidentes más comunes observamos que los derrapados y atropellamientos presentan cifras muy altas. Esto puede indicar problemas relacionados con pavimentación, lluvia, exceso de velocidad y poca seguridad peatonal en ciertas zonas.
 9. Las intersecciones no semaforizadas presentan muchos más accidentes y fallecidos que las semaforizadas. Esto sugiere que la infraestructura vial y el control del tránsito sí tienen un impacto importante en la seguridad, lo que complementa también información sobre la seguridad peatonal de la ciudad y posibles mejoras que pueden implementarse como la instalación de semáforos en aquellas zonas problemáticas con mucho flujo vehicular.
 10. El análisis temporal muestra cifras preocupantes, pues algunos accidentes tardan muchísimo tiempo en ser capturados en el sistema, llegando incluso a más de un año. Consideramos también la posibilidad de que varios reportes hayan sido dados de alta mucho después de que realmente ocurrieron los hechos. Esto podría deberse a procesos administrativos lentos, manejo manual de información (reportes en papel o retrasos en la digitalización y actualización de los registros). Al no tener la certeza estas aseveraciones sólo las planteamos como mera hipótesis.
 11. Los fines de semana, especialmente sábado y viernes que son los días con más accidentes. Esto podría relacionarse con mayor movilidad social, actividades nocturnas y posiblemente conducción bajo efectos del alcohol.
 12. Otro hallazgo importante es que las horas con más accidentes ocurren entre las 8 y 9 de la mañana y entre las 2 y 7 de la tarde. Esto coincide con horarios de entrada y salida laboral y escolar. Aunque bien se mostró que la mayoría de incidentes son en fines de semana consideramos que algo importante (que resultaría interesante consultar si el usuario lo desea) una querie para ver como se agrupan estos eventos tanto por la hora en la que ocurrieron como el día que pasaron.

En general, los datos muestran que los accidentes no dependen de un solo factor, sino de la combinación entre alta movilidad, infraestructura deficiente, condiciones climáticas y concentración urbana. Si bien variables como el clima o la densidad poblacional son difíciles de modificar directamente existen otros aspectos que sí pueden mejorarse mediante políticas públicas y acciones de infraestructura, como la pavimentación, la optimización de los procesos administrativos de reporte y captura de incidentes, así como la correcta semaforización y señalización vial.

Con base en estos hallazgos, idealmente se contempla elaborar una propuesta de mejora dirigida a la Secretaría de Movilidad de la Ciudad de México y a otras dependencias responsables de esto con el objetivo de presentar sugerencias sustentadas en los resultados obtenidos durante el análisis. 
