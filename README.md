...
** Entrega 1: Introducción al conjunto de datos y al problema a estudiar considerando aspectos éticos del conjunto de datos empleado**
### TODO | Seleccionar un set de datos
El equipo debe seleccionar una fuente de datos de su preferencia para la ejecución del
proyecto. La fuente de datos deberá ser real, pública y de interés para el resto del grupo.
...
- No puede ser una base de datos normalizada que se desnormalice como parte del
proyecto

### TODO | Detallar los siguientes aspectos:
